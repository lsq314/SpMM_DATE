...
#pragma HLS INTERFACE m_axi depth=13515 port=B_rcsr5 offset=slave bundle=brcsr5
#pragma HLS INTERFACE m_axi depth=13515 port=B_rcsr6 offset=slave bundle=brcsr6
#pragma HLS INTERFACE m_axi depth=13515 port=B_rcsr7 offset=slave bundle=brcsr7
#pragma HLS INTERFACE m_axi depth=13515 port=B_rcsr8 offset=slave bundle=brcsr8
...
#pragma HLS STREAM variable=vcache_bank4_result depth=8
	...
	vcresult_stream vcache_bank1_vresult1, vcache_bank1_cresult1, vcache_bank1_vresult2, vcache_bank1_cresult2,
	                vcache_bank1_vresult3, vcache_bank1_cresult3, vcache_bank1_vresult4, vcache_bank1_cresult4,
					vcache_bank2_vresult1, vcache_bank2_cresult1, vcache_bank2_vresult2, vcache_bank2_cresult2,
					vcache_bank2_vresult3, vcache_bank2_cresult3, vcache_bank2_vresult4, vcache_bank2_cresult4,
					vcache_bank3_vresult1, vcache_bank3_cresult1, vcache_bank3_vresult2, vcache_bank3_cresult2,
					vcache_bank3_vresult3, vcache_bank3_cresult3, vcache_bank3_vresult4, vcache_bank3_cresult4,
					vcache_bank4_vresult1, vcache_bank4_cresult1, vcache_bank4_vresult2, vcache_bank4_cresult2,
					vcache_bank4_vresult3, vcache_bank4_cresult3, vcache_bank4_vresult4, vcache_bank4_cresult4;
#pragma HLS STREAM variable=vcache_bank1_vresult1 depth=8
#pragma HLS STREAM variable=vcache_bank1_vresult2 depth=8
#pragma HLS STREAM variable=vcache_bank1_vresult3 depth=8
#pragma HLS STREAM variable=vcache_bank1_vresult4 depth=8
#pragma HLS STREAM variable=vcache_bank2_vresult1 depth=8
#pragma HLS STREAM variable=vcache_bank2_vresult2 depth=8
#pragma HLS STREAM variable=vcache_bank2_vresult3 depth=8
#pragma HLS STREAM variable=vcache_bank2_vresult4 depth=8
#pragma HLS STREAM variable=vcache_bank3_vresult1 depth=8
#pragma HLS STREAM variable=vcache_bank3_vresult2 depth=8
#pragma HLS STREAM variable=vcache_bank3_vresult3 depth=8
#pragma HLS STREAM variable=vcache_bank3_vresult4 depth=8
#pragma HLS STREAM variable=vcache_bank4_vresult1 depth=8
#pragma HLS STREAM variable=vcache_bank4_vresult2 depth=8
#pragma HLS STREAM variable=vcache_bank4_vresult3 depth=8
#pragma HLS STREAM variable=vcache_bank4_vresult4 depth=8
#pragma HLS STREAM variable=vcache_bank1_cresult1 depth=8
#pragma HLS STREAM variable=vcache_bank1_cresult2 depth=8
#pragma HLS STREAM variable=vcache_bank1_cresult3 depth=8
#pragma HLS STREAM variable=vcache_bank1_cresult4 depth=8
#pragma HLS STREAM variable=vcache_bank2_cresult1 depth=8
#pragma HLS STREAM variable=vcache_bank2_cresult2 depth=8
#pragma HLS STREAM variable=vcache_bank2_cresult3 depth=8
#pragma HLS STREAM variable=vcache_bank2_cresult4 depth=8
#pragma HLS STREAM variable=vcache_bank3_cresult1 depth=8
#pragma HLS STREAM variable=vcache_bank3_cresult2 depth=8
#pragma HLS STREAM variable=vcache_bank3_cresult3 depth=8
#pragma HLS STREAM variable=vcache_bank3_cresult4 depth=8
#pragma HLS STREAM variable=vcache_bank4_cresult1 depth=8
#pragma HLS STREAM variable=vcache_bank4_cresult2 depth=8
#pragma HLS STREAM variable=vcache_bank4_cresult3 depth=8
#pragma HLS STREAM variable=vcache_bank4_cresult4 depth=8
#pragma HLS BIND_STORAGE variable=vcache_bank1_vresult1 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank1_vresult2 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank1_vresult3 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank1_vresult4 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank2_vresult1 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank2_vresult2 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank2_vresult3 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank2_vresult4 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank3_vresult1 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank3_vresult2 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank3_vresult3 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank3_vresult4 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank4_vresult1 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank4_vresult2 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank4_vresult3 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank4_vresult4 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank1_cresult1 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank1_cresult2 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank1_cresult3 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank1_cresult4 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank2_cresult1 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank2_cresult2 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank2_cresult3 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank2_cresult4 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank3_cresult1 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank3_cresult2 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank3_cresult3 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank3_cresult4 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank4_cresult1 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank4_cresult2 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank4_cresult3 type=fifo impl=srl
#pragma HLS BIND_STORAGE variable=vcache_bank4_cresult4 type=fifo impl=srl
...
//	merge_4_to_1_mi(&mi1, &mi2, &mi3, &mi4, &mif);
//	distributer_mi(&mif, &rm1_idle, &rm2_idle, &rm3_idle, &rm4_idle);
...
//	merge_4_to_1_rresponse(&rcache_bank1_res, &rcache_bank2_res, &rcache_bank3_res, &rcache_bank4_res, &rcache_res_final);
//	distributer_rresponse(&rcache_res_final, &rresponse1, &rresponse2, &rresponse3, &rresponse4);
	...
	distributer_vcresult(&vcache_bank1_result, &vcache_bank1_vresult1, &vcache_bank1_vresult2, &vcache_bank1_vresult3, &vcache_bank1_vresult4);
	distributer_vcresult(&vcache_bank2_result, &vcache_bank2_vresult1, &vcache_bank2_vresult2, &vcache_bank2_vresult3, &vcache_bank2_vresult4);
	distributer_vcresult(&vcache_bank3_result, &vcache_bank3_cresult1, &vcache_bank3_cresult2, &vcache_bank3_cresult3, &vcache_bank3_cresult4);
	distributer_vcresult(&vcache_bank4_result, &vcache_bank4_cresult1, &vcache_bank4_cresult2, &vcache_bank4_cresult3, &vcache_bank4_cresult4);

	merge_2_to_1_vcresult(&vcache_bank1_vresult1, &vcache_bank2_vresult1, &vresult1);
	merge_2_to_1_vcresult(&vcache_bank1_vresult2, &vcache_bank2_vresult2, &vresult2);
	merge_2_to_1_vcresult(&vcache_bank1_vresult3, &vcache_bank2_vresult3, &vresult3);
	merge_2_to_1_vcresult(&vcache_bank1_vresult4, &vcache_bank2_vresult4, &vresult4);
	merge_2_to_1_vcresult(&vcache_bank3_cresult1, &vcache_bank4_cresult1, &cresult1);
	merge_2_to_1_vcresult(&vcache_bank3_cresult2, &vcache_bank4_cresult2, &cresult2);
	merge_2_to_1_vcresult(&vcache_bank3_cresult3, &vcache_bank4_cresult3, &cresult3);
	merge_2_to_1_vcresult(&vcache_bank3_cresult4, &vcache_bank4_cresult4, &cresult4);

	pe(&cblock1, &vblock1, &cblock1d, &vblock1d, &pe1_job, &p_pe1, &B_rlen_pe1, &mc_pe1, &pe1_idle, &efinish1);
	pe(&cblock2, &vblock2, &cblock2d, &vblock2d, &pe2_job, &p_pe2, &B_rlen_pe2, &mc_pe2, &pe2_idle, &efinish2);
	pe(&cblock3, &vblock3, &cblock3d, &vblock3d, &pe3_job, &p_pe3, &B_rlen_pe3, &mc_pe3, &pe3_idle, &efinish3);
	pe(&cblock4, &vblock4, &cblock4d, &vblock4d, &pe4_job, &p_pe4, &B_rlen_pe4, &mc_pe4, &pe4_idle, &efinish4);
